...
cp /var/www/qiaothink/qiaothink.conf /etc/supervisor/conf.d/qiaothink.conf
# 不要再 sites-available 里面放任何东西
cp /var/www/qiaothink/qiaothink.nginx /etc/nginx/sites-enabled/qiaothink
chmod -R o+rwx /var/www/qiaothink

# 初始化
cd /var/www/qiaothink
python3 reset.py
