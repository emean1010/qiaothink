...
def reset_database():
    ...
    with e.connect() as c:
        c.execute('DROP DATABASE IF EXISTS qiaothink')
        c.execute('CREATE DATABASE qiaothink CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci')
        c.execute('USE qiaothink')
